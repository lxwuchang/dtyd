...
public class Excel2007WriterMailPriceMonthByManager {
	...
	private int twfnum=0;
	private double twfprice=0;
	
	private int tyfnum=0;
	private double tyfprice=0;
	public void createSheet(){
		...
		sh.setColumnWidth((short)14,(short)1800);
		sh.setColumnWidth((short)15,(short)1800);
		sh.setColumnWidth((short)16,(short)1800);
    ...
    public void process(String filename,List dataList,int startnum,int total) throws Exception 
    {
        ...
        if(dataList!=null&&dataList.size()>0)
    	 ...
    	 for(int rownum = 0; rownum < len; rownum++)
    	 {
    		 ...
    		 twfnum=twfnum+b.getWfnum();
    		 twfprice=twfprice+b.getWfprice();
    		 
    		 tyfnum=tyfnum+b.getYfnum();
    		 tyfprice=tyfprice+b.getYfprice();
    		 ...
    		 mnum=mnum+1;
	            ...
	            cell = row.createCell(14);  
	            address = new CellReference(cell).formatAsString();
	            cell.setCellValue(b.getYfprice());
	            cell.setCellStyle(style);
	            
	            cell = row.createCell(15);  
	            address = new CellReference(cell).formatAsString();
	            cell.setCellValue(b.getWfnum());
	            cell.setCellStyle(style);
	            ...
	            cell = row.createCell(16);  
	            address = new CellReference(cell).formatAsString();
	            cell.setCellValue(b.getWfprice());
	            cell.setCellStyle(style);
    	 ...
    	 if(total==mnum){
			...
			double whole=0;
    		 Row row = sh.createRow(total+1);
              ...
              cell = row.createCell(1);  
    			...
    			// 保留2位小数
   	      tpprice = bb.setScale(2, BigDecimal.ROUND_HALF_UP)
    					.doubleValue();
   	           cell = row.createCell(2);  
             address = new CellReference(cell).formatAsString();
 			...
 			// 保留2位小数
             tdprice = bb.setScale(2, BigDecimal.ROUND_HALF_UP)
 					.doubleValue();
            ...
            bb = new BigDecimal(tcprice);
   			// 保留2位小数
            tcprice = bb.setScale(2, BigDecimal.ROUND_HALF_UP)
   					.doubleValue();
              cell = row.createCell(6);  
              address = new CellReference(cell).formatAsString();
              ...
              trprice = bb.setScale(2, BigDecimal.ROUND_HALF_UP)
					.doubleValue();
            ...
            tfprice = bb.setScale(2, BigDecimal.ROUND_HALF_UP)
					.doubleValue();
          ...
          cell = row.createCell(13);  
          address = new CellReference(cell).formatAsString();  
          cell.setCellValue(tyfnum);
          cell.setCellStyle(style);
          
          
          bb = new BigDecimal(tyfprice);
          tyfprice = bb.setScale(2, BigDecimal.ROUND_HALF_UP)
				.doubleValue();
      
          cell = row.createCell(14);  
          address = new CellReference(cell).formatAsString();
          cell.setCellValue(tyfprice);
          cell.setCellStyle(style);
          
          
          cell = row.createCell(15);  
          address = new CellReference(cell).formatAsString();  
          cell.setCellValue(twfnum);
          cell.setCellStyle(style);
          
          
          bb = new BigDecimal(twfprice);
          twfprice = bb.setScale(2, BigDecimal.ROUND_HALF_UP)
				.doubleValue();
      
          cell = row.createCell(16);  
          address = new CellReference(cell).formatAsString();
          cell.setCellValue(twfprice);
          cell.setCellStyle(style);

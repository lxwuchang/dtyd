...
public class Excel2007Writer {
	...
	public void createSheet(){
		...
		sh.setColumnWidth((short)0,(short)1280);
    ...
    public void process(String filename,List dataList,int startnum,int total) throws Exception 
    {
        ...
        Font font =  wb.createFont();
         font.setFontHeightInPoints((short)8); //字体高度
    	 ...
    	 if(total==mnum){
			...
			// 保留2位小数
			tweight = bb.setScale(2, BigDecimal.ROUND_HALF_UP)
					.doubleValue();
			...
			// 保留2位小数
     		tscanfei = bb.setScale(2, BigDecimal.ROUND_HALF_UP)
					.doubleValue();
             ...
             bb = new BigDecimal(ttransformprice+tbuzhufei+tweightprice+tscanfei);
    			// 保留2位小数

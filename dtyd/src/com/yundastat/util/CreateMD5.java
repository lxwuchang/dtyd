...
public class CreateMD5 {
    static Log log=LogFactory.getLog(CreateMD5.class);
    
    /**
     * 用MD5算法加密口令 Creation date: (5/11/00 5:03:58 PM)
     * 
     * @param String
     *            口令明文
     * @return String 加密的口令
    ...
    public static String createMD5(String passwordSource) {
         ...
         try {
             ...
             log.error("Failed to Create MD5 password. " + e);
             return passwordSource;
         }
         String ReturnPassword = WebmacroBase64.encode(PasswordByte);
         //Base64.encode(ReturnPassword.getBytes());
    ...
    public final static class WebmacroBase64 {
     ...
     public   static void main(String arg[]) {
    	 ...
    	 CreateMD5 d=new CreateMD5();
    	 String ss=CreateMD5.createMD5("wuchang2012-06-12wuchang");
    	 
    	// SUM)NVk7eFpCMT9XU3djVkxTTkxjQT09

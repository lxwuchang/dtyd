 ...
 * 
 * <p>
 * �������һ��hash���lookup���ұ����ϵ��㷨��ȷ������entities�����ܡ�
 * </p>
 *
 * @author Michael Zhou
 * @version $Id: Entities.java,v 1.1 2012/05/17 22:50:07 wuchang Exp $
 *
...
public class Entities {
    ...
    /** HTML 4.0ʵ�嶨�壨http://www.w3.org/TR/REC-html40/sgml/entities.html���� */
